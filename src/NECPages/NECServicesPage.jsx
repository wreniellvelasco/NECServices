    ...
    return (
        ...
        >
            ...
            <CardActions sx={{ flexDirection: 'column', gap: 1, p: 2, pt: 0 }}>
                ...
                <Button variant="contained" color="primary" fullWidth onClick={handleExamPackage}>
                    See Full Details
                </Button>
            </CardActions>
        </Card>
    ...
    return (
        ...
        >
            ...
            <CardActions sx={{ flexDirection: 'column', gap: 1, p: 2, pt: 0 }}>
                ...
                <Button variant="contained" color="primary" fullWidth onClick={handleOtherPackage}>
                    See Full Details
                </Button>
            </CardActions>
        </Card>
...
//
export default function NECServicesPage() {
